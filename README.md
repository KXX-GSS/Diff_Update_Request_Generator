...
## How to use
- 下載 [Release Note](https://github.com/KXX-GSS/Diff_Update_Request_Generator/release)。
- 填寫Config案所需的資訊。
...
## How to use
- download the [latest release](https://github.com/KXX-GSS/Diff_Update_Request_Generator/release)  .
